# flask-live-text-to-speech

Flask demo app for Deepgram Live Text-to-Speech.
...
```
feat(flask-live-text-to-speech): add diarization support
fix(flask-live-text-to-speech): resolve WebSocket close handling
refactor(flask-live-text-to-speech): simplify session endpoint
